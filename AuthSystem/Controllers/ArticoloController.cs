...
namespace AuthSystem.Controllers
{
    public class ArticoloController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CodiceArticolo,Descrizione")] Articolo articolo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CodiceArticolo,Descrizione")] Articolo articolo)
        {
