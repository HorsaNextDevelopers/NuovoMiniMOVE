...
namespace AuthSystem.Controllers
{
    public class OdlController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CodiceOdl,QuantitaDaProdurre,DataInizio,DataFine,CodiceArticolo")] Odl odl)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CodiceOdl,QuantitaDaProdurre,DataInizio,DataFine,CodiceArticolo")] Odl odl)
        {
            if (id != odl.CodiceOdl)
            {
                return NotFound();
